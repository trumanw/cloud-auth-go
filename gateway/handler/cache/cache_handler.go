...
func (ch *CacheHandler) ServeHTTP(rw http.ResponseWriter, r *http.Request, next http.HandlerFunc) {
...
func (ch *CacheHandler) ServeResource(res *Resource, rw http.ResponseWriter, req *CacheRequest) {
...
func (ch *CacheHandler) UpstreamWithCache(rw http.ResponseWriter, r *CacheRequest, next http.HandlerFunc) {
...
func (ch *CacheHandler) CacheResource(res *Resource, r *CacheRequest) {
    Writes.Add(1)
...
func (ch *CacheHandler) LookupInCached(req *CacheRequest) (*Resource, error) {
...
func (ch *CacheHandler) Freshness(res *Resource, r *CacheRequest) (time.Duration, error) {
...
func (ch *CacheHandler) isCacheable(res *Resource, r *CacheRequest) bool {
